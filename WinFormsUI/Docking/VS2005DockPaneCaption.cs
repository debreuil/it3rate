	...
	internal class VS2005DockPaneCaption : DockPaneCaptionBase
	{
		...
		private bool ShouldShowAutoHideButton
		{
			get
            {
                ...
                //bool ahv = DockPane.ActiveContent == null || 
                //    DockPane.ActiveContent.DockHandler == null || 
                //    DockPane.ActiveContent.DockHandler.AutoHideButtonVisible;
                //return !DockPane.IsFloat && ahv;	
            }
		}
